(function($) {
    $.fn.jquizzy = function(settings) {
        ...
        answers = [],
        introFob = '	<div class="intro-container slide-container"><a class="nav-start" href="#">萌星系历史题库，Are you ready？<br/><br/><span><img src="'+config.startImg+'"></span></a></div>	',
        ...
        superContainer.find('.final').click(function() {
            ...
            superContainer.find('li').each(function(index) {
				...
				//userAnswers.push($(this).parents('.answers').children('li').index + 1);
            });
            ...
            toLoopTill = results.length; i < toLoopTill; i++) {
                ...
                resultSet += '<li>' + config.questions[i].tip+ '</li>';
                resultSet += '<li>' + config.questions[i].tipanswer+ '</li>';
